...
select order_id, round(expected_price::numeric, 2) as expected_price, round(actual_price::numeric, 2) as actual_price, round((expected_price - actual_price)::numeric, 2) as price_difference
from prices
